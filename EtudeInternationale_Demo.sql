...
--
-- Host: SB0134-WINWEB
-- Generation Time: Mar 10, 2020 at 02:04 PM
...
(99, 2, 'Activite1', 'desc1', '2020-03-10', '2020-03-10');
...
(1, 11, 'Aide Humanitaire', 'Mogadishu', '2000.00', '2020-08-10', '2020-03-10', '2020-08-20', 1, 0, 'Trop Dangereux', 206, 'Aide humanitaire'),
(2, 11, 'Culinaire', 'Paris', '500.00', '2020-06-10', '2020-04-10', '2020-06-10', 1, 0, NULL, 80, 'Grande École Culinaire de Paris');
...
(4, 16, 'Sur une note de 1 à 10. Comment avez-vous apprécié le voyage ?', '0;100;1', 'Chiffre', 1, '', 0),
(5, 16, 'Quels sont les objectifs de ce voyage?', '', 'ZoneTexte', 1, 'Écrire un court texte', 9),
...
(8, 9, 'Quel sera la principale source de financement du voyage?', NULL, 'ZoneTexte', 1, 'Faire une courte liste', 9),
(9, 13, 'Liste des numéros d\'urgence', NULL, 'Fichier', 1, '', 1);
...
(1, 2, 'Paris', '500.00', '2020-05-10', '2020-04-10', '2020-06-10', 1, 0, 80, 'Voyage Culinaire', 'Grande École Culinaire de Paris');
...
--
ALTER TABLE `activations`
  MODIFY `id_activation` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=22;

--
-- AUTO_INCREMENT for table `activites`
--
ALTER TABLE `activites`
  MODIFY `id_activite` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=101;
...
--
ALTER TABLE `formulaires`
  MODIFY `id_formulaire` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=12;
...
--
ALTER TABLE `propositions`
  MODIFY `id_proposition` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=30;
